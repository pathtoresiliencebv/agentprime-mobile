...
interface AgentPrimeLoaderProps {
  /**
...
/**
 * AgentPrimeLoader - A unified loading animation component
 * 
 ...
 * <AgentPrimeLoader forceTheme="dark" />
 * 
 * // With ref for manual control
 * const lottieRef = useRef<LottieView>(null);
 * <AgentPrimeLoader lottieRef={lottieRef} autoPlay={false} />
 * ```
 */
export function AgentPrimeLoader({
  size = 'medium',
  speed = 1.2,
  customSize,
  className,
